/**
 * Instructions:
 * The test suite listed below does not work fine. Create another test suite which sets up tests using beforeEach().
 * 1. Add beforeEach() to set up a num variable to be used in tests.
 * 2. Run the tests and check it works fine now.
 * 
